...
public interface PBBAPopupCallback {
     ...
     *
     * @see com.zapp.library.merchant.util.PBBAAppUtils#showPBBAPopup(FragmentActivity, String, String, PBBAPopupCallback, long,com.zapp.library.merchant.util.RequestType)
     * @see com.zapp.library.merchant.util.PBBAAppUtils#showPBBAErrorPopup(FragmentActivity, String, String, String, PBBAPopupCallback)
