...
public final class PBBAPopupFragment extends PBBAPopup {
    ...
    public static PBBAPopupFragment newInstance(@NonNull final String secureToken, @NonNull final String brn, final long
            timeoutTS, @NonNull final RequestType requestType) {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
			...
			mRequestType = (RequestType) savedInstanceState.getSerializable(KEY_REQUEST_TYPE);
        } else {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable final Bundle savedInstanceState) {
        ...
        configureStepsTextMessage(view,mRequestType);
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (countDownTimer != null) {
			...
			outState.putSerializable(KEY_REQUEST_TYPE,mRequestType);
        }
