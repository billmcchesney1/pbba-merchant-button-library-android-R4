...
import com.zapp.library.merchant.util.RequestType;
...
public final class PBBAPopupIntermediaryFragment extends PBBAPopup {
    ...
    /**
     * Key for fragment argument: Request Type.
     */
    private static final String KEY_REQUEST_TYPE = "key.requestType";
    ...
    public static PBBAPopupIntermediaryFragment newInstance(@NonNull final String secureToken, @NonNull final String brn, final long timeoutTS, final
        ...
        arguments.putSerializable(KEY_REQUEST_TYPE, requestType);
    ...
    public void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        mRequestType = (RequestType) arguments.getSerializable(KEY_REQUEST_TYPE);
    }
        ...
        openBankingAppButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (activity != null) {
                    ...
                    if (PBBAAppUtils.isCFIAppAvailable(activity,mRequestType)) {
                        dismiss();
                        PBBAAppUtils.openBankingApp(activity, mSecureToken,mRequestType);
                    } else {
                        onDisplayBrn();
                    }
                }
    ...
    private void onDisplayBrn() {
        ...
        final PBBAPopupFragment newFragment = PBBAPopupFragment.newInstance(mSecureToken, mBrn, mTimeoutTS, mRequestType);
