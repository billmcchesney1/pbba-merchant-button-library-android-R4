...
public class TestSuite {
    ...
    /**
     * Constant pay request
     */
    public static final RequestType REQUEST_TO_PAY = RequestType.REQUEST_TO_PAY;

    /**
     * Constant linking request
     */
    public static final RequestType REQUEST_TO_LINK = RequestType.REQUEST_TO_LINK;
    ...
    /**
     * Contant Linking intent URI
     */
    public static final String LINKING_INTENT_URI = String.format("zapp-r4://%s?apiName=%s", SECURE_TOKEN, REQUEST_TO_LINK.getTypeOfRequest());
