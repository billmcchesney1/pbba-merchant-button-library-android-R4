...
public class ShowPBBAPopupTest {
    ...
    /**
     * Flag to track if callback onStartTimer has been called.
     */
    private boolean mOnStartTimerCalled;

    /**
     * Flag to track if callback onStartTimer has been called.
     */
    private boolean mOnEndTimerCalled;
    ...
    private final PBBAPopupCallback mCallback = new PBBAPopupCallback() {
        ...
        public void onStartTimer() {
            mOnStartTimerCalled = true;
        }

        @Override
        public void onEndTimer() {
            mOnEndTimerCalled = true;
        }
    ...
    public void testShowPBBAPopupNulls() throws Exception {
        PBBAAppUtils.showPBBAPopup(/* fragmentActivity */ null, /* secureToken */ null, /* brn */ null, /* mCallback */ null,/*timeoutTS*/-1, /*requestType*/null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testShowPBBAPopupNoSecureToken() throws Exception {
        final TestActivity activity = mActivityTestRule.getActivity();
        PBBAAppUtils.showPBBAPopup(/* fragmentActivity */ activity, /* secureToken */ null, TestSuite.BRN, /* mCallback */ null,TestSuite.TIMEOUT_TS,TestSuite.REQUEST_TO_PAY);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testShowPBBAPopupNoBRN() throws Exception {
        final TestActivity activity = mActivityTestRule.getActivity();
        PBBAAppUtils.showPBBAPopup(/* fragmentActivity */ activity, TestSuite.SECURE_TOKEN, /* brn */ null, /* mCallback */ null,TestSuite.TIMEOUT_TS,TestSuite.REQUEST_TO_PAY);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testShowPBBAPopupInvalidBRN() throws Exception {
        final TestActivity activity = mActivityTestRule.getActivity();
        PBBAAppUtils.showPBBAPopup(/* fragmentActivity */ activity, TestSuite.SECURE_TOKEN, TestSuite.INVALID_BRN, /* mCallback */ null,TestSuite.TIMEOUT_TS,TestSuite.REQUEST_TO_PAY);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testShowPBBAPopupNoCallback() throws Exception {
        final TestActivity activity = mActivityTestRule.getActivity();
        PBBAAppUtils.showPBBAPopup(/* fragmentActivity */ activity, TestSuite.SECURE_TOKEN, TestSuite.BRN, /* mCallback */ null,TestSuite.TIMEOUT_TS,TestSuite.REQUEST_TO_PAY);
    }

    @Test
    public void testShowPBBAPopupOK() throws Exception {
        final TestActivity activity = mActivityTestRule.getActivity();
        PBBAAppUtils.showPBBAPopup(/* fragmentActivity */ activity, TestSuite.SECURE_TOKEN, TestSuite.BRN, mCallback,TestSuite.TIMEOUT_TS,TestSuite.REQUEST_TO_PAY);
    ...
    public void testShowPBBAPopupTwiceDifferentBRN() throws Exception {
        ...
        PBBAAppUtils.showPBBAPopup(/* fragmentActivity */ activity, TestSuite.SECURE_TOKEN, TestSuite.BRN2, mCallback,TestSuite.TIMEOUT_TS,TestSuite.REQUEST_TO_PAY);
        Espresso.onView(ViewMatchers.withId(R.id.pbba_popup_close)).perform(ViewActions.click());
        Assert.assertFalse(TestSuite.ON_RETRY_PAYMENT_REQUEST_SHOULD_NOT_BE_CALLED, mOnRetryPaymentRequestCalled);
        Assert.assertTrue(TestSuite.ON_DISMISS_POPUP_CALLED_SHOULD_BE_CALLED, mOnDismissPopupCalled);
    }
